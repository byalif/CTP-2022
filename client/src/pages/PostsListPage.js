    ...
    <>
      ...
      <Layout>
        ...
        <div className="partners-logos d-flex justify-center">
          ...
          <div className="d-flex align-items-center">
            <img src="./icon.png"></img>
            <span className="px-2">SECOND HAND</span>
          </div>
        </div>
        <div className="second-landing-section">
          <div className="text-start landing-main-text">
            ...
            <p className="text-uppercase">
              A new fashion-related social network
            </p>
          </div>
          <div className="d-flex text-start text-block">
            <div>
              <p>
                We want our users to express themselves and share their ideas.
                iWardrobe is the place where creativity begins.
              </p>
              <p>
                We also want to make this world a better place. You can exchange
                things you don’t need anymore through iWardrobe.{" "}
              </p>
              <p>
                You have tons of your mirror looks on your phone? It's time to
                show them to other people. <br></br> Share! Follow! Like!
                Comment!{" "}
              </p>
            </div>
        ...
        <div className="d-flex my-5">
          <div className="section-text-block">
            <div className="section-header-promo">
              <span className="bold">Improve </span>your brand{" "}
              <span>with an awesome site.</span>
            </div>
        ...
        <div className="talk-pannel d-flex mb-6 align-items-center">
          ...
          <div className="circle-btn d-flex">
            Send<br></br> Us A <br></br> Feed Back
          </div>
        </div>
      </Layout>
    </>
